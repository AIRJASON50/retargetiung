...
Usage:
    ...
    PYTHONPATH=src python demos/hocap.py --clip hocap__subject_2__20231022_200657__seg00
    PYTHONPATH=src python demos/hocap.py --obj-samples 100
"""
...
from scene_builder.hand_builder import _inject_fingertip_sites, _inject_wrist6dof_mode  # noqa: E402
...
def main():
    ...
    parser.add_argument("--np-mode", choices=["off", "warmup", "s2", "both"], default=None,
                        help="Non-penetration constraint scope; also picks cache stamped np-D/A/B/C. "
                             "Shorthand for --cache <...__np-X.npz> when experiments/penetration_ablation/run.py caches exist.")
    args = parser.parse_args()

    # --np-mode shorthand: pick the matching cache stamp produced by
    # experiments/penetration_ablation/run.py
