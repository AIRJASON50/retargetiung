...
Usage:
    ...
    PYTHONPATH=src python demos/manus.py --speed 0.5
    PYTHONPATH=src python demos/manus.py --no-mesh          # hide mesh overlay
    PYTHONPATH=src python demos/manus.py --no-source        # hide source keypoints
"""
