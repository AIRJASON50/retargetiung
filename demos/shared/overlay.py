...
model transparency in the MuJoCo passive viewer.  All five demo scripts
(play_manus, play_interaction_mesh, play_mesh_only, play_hocap,
play_omniretarget_demo) share the same underlying draw calls -- this
module consolidates them into a single source of truth.
"""
