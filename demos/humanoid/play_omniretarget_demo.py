...
Usage:
    python scripts/play_omniretarget_demo.py                    # robot_only (default)
    python scripts/play_omniretarget_demo.py --mode box         # with largebox
    python scripts/play_omniretarget_demo.py --mode slope       # with terrain slope
    python scripts/play_omniretarget_demo.py --speed 0.3
"""
