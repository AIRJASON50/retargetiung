...
demos/hocap.py --cache for 4-way visual comparison.

Usage:
    PYTHONPATH=src python experiments/penetration_ablation/run.py            # full
    PYTHONPATH=src python experiments/penetration_ablation/run.py --quick    # 100f × 1 clip
"""
